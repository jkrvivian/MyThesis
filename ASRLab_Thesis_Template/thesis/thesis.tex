...
\usepackage{listings, makecell, multirow}
...
\begin{minipage}[c][5cm][t]{\textwidth}
  \begin{center}
    ...
    {\center \Large 針對物聯網資料交易的 \\ 去中心化基礎建設}}
    \vspace{0.5cm}\\
    \makebox[\textwidth][c]{\parbox{\paperwidth}
  ...
  \begin{center}
    {
      ...
      \makebox[6.0em][l]{\Large 涂嘉恒 博士}
      \makebox[8.0em][c]{}
      \makebox[4.0em][r]{\Large Advisor：}
      \makebox[8.0em][l]{\Large Dr. Chia-Heng Tu}
      \vspace{0.1cm}\\
      % -------------Co-Advisor-1-------------
      \hspace{2.0em}
      \makebox[4.0em][r]{\Large 共同指導：}
      \makebox[6.0em][l]{\Large 黃敬群}
      \makebox[8.0em][c]{}
      \makebox[4.0em][r]{\Large Co-Advisor：}
      \makebox[8.0em][l]{\Large Ching-Chun Huang}
      \vspace{0.1cm}\\
    }
  \end{center}
\end{minipage}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=3.in]{img/system_design}
...
\begin{figure}
    \centering
    \includegraphics[width=15cm]{img/pub_sub_model}
...
\begin{figure}
    \centering
    \includegraphics[width=15cm]{img/channel_and_key}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=3.in]{img/DID_VC}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=3.5in]{img/TangleID}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=4in]{img/smart_contract_mam}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=3.5in]{img/key_upload}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=3.5in]{img/mam_structure}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=3.5in]{img/ta_structure}
...
The E2EE protocol presented in this paper combines a series of different cryptographic procedures. Each of them can be chosen according to the working hardware and scenario. On some hardwares, the developers can choose the cryptographic methods with hardware acceleration. With hardware acceleration, the elapsed time could be dropped a step more.
...
\newpage
\phantomsection
\chapter{Decentralized Subscription-based Data Trading Case Study}
\pagestyle{plain}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=2.5in]{img/launching_product}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=3.5in]{img/key_exchange}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=3.5in]{img/unsubscribe}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.5in]{img/refund}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=3.in]{img/mam_create}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=3.in]{img/mam_send}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=3.5in]{img/rpi3_pow}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=3in]{img/mam_vs_e2ee}
